...
<body>
  ...
  <?php
		...
		$sql="INSERT INTO recettes(`nom`,`categorie`,`difficulte`,`cout`,`temps_prep`,`ingredients`,`recette`,`photo`) VALUES(`$nom`,`$entree`,`$plat`,`$dessert`,`$difficulte`,`$cout`,`$temps`,`$ingredients`,`$recette`,`$photo`)";
